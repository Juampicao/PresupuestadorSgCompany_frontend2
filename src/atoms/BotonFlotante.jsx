...
import { ColorAzul, ColorRojo, ColorVerde } from "../helpers/colores.js";
import { ICONS } from "../helpers/images.js";

const BotonFlotante = () => {
  //   const [abrirBoton, setAbrirBoton] = useState(true);
        ...
        <div>
          <div className="dropup relative ">
            <button
              ...
              aria-expanded="false"
            >
              <img src={ICONS.addImage} alt="" className="h-10 " />
            </button>
        ...
        "
            ...
            >
              <button
                ...
                aria-expanded="false"
              >
                <img src={ICONS.addImage} alt="" className="h-6 " />
